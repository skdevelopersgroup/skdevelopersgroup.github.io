...
$mail="azaam.ali@adglobal360.com,harinath@skdevelopersgroup.com,noor.mohameed@adglobal360.com";
...
$Msg = '<table width="865" border="0">
  ...
  <tr>
    <td>Enquiry For Sk Developers</td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td>Yours sincerely,<br />SK Developers </td>
  </tr>
</table>';
...
$Subjectnew    = "Enquiry For Sk Developers";
...
<div class="wrapper"></div>
  ...
  <div class="arrow_center">
    ...
    <img src="images/phone-icon.png"/><span>&nbsp; 7550005833 </span>
      ...
      <h2><span class="starting">Fill the Form below</span><br /> <strong>We will get back to you</strong> </h2>
      
      <div class="formMain">
      	<form name="contactnew" action="thankyou.php" method="post" onSubmit="return contnew_validate();" >
      		<div class="block2"><div class="textclass"><input placeholder="Name*" name="name" id="name" type="text" class="forminput" ></div>
      		</div>
      		<div class="block3"><div class="textclass"><input placeholder="Email*" name="email" id="email" type="text" class="forminput" >
            </div></div>
      		<div class="block4"><div class="textclass"><input placeholder="Phone*" name="mobile" id="mobile" type="text" class="forminput">
            </div></div>
      		<div class="block5"><div class="textclass"><textarea placeholder="Query" name="message" id="message" class="forminput"></textarea>
            </div></div>
      		<div class="submitclass"><input type="submit" name="Submit" value="Submit" class="forminput"></div>
      </form>
      </div>
    </div>
  </div>
      ...
      <div class="advantages_sec_hom">
        ...
        <ul>
          <li class="first">
            ...
            <a href="#inline2" class="fancybox" title=""><img src="images/exp.jpg"  /></a> </li>
          <li>
            <h3>Floor Plans</h3>
          ...
          <li class="last">
            ...
            <a href="#inline4" class="fancybox" title=""><img src="images/exp.jpg"  /></a> </li>
        </ul>
      </div>
    </div>
